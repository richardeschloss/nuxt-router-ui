...
// TBD: in Nuxt3 / vue3, the dynamic routes will be [param] instead of _param
...
export default {
  render (h) {
    ...
    }, [this.showParamsModal ? paramsModal : routesModal])
